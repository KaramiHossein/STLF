function prediction = MethodS(A,yy,mm,dd,daytypesIn,spdtypesIn,ramezanIn,L,ll,weatherIn,FittedWeather,flagD)  
...
for i=ll(end):(length(daytypesIn)-1)
    if daytypesIn(i)==5
        ...
        [prediction1]=similarpredict(Aaa(1:i,:),Aaa(i,1),Aaa(i,2),Aaa(i,3),daytypesa(1:i),spdtypesIn(1:i),ramezanIn(1:i),L,weatherIn,FittedWeather,flagDaa(1:i,:));
...
[prediction]=similarpredict(Aaa,yy,mm,dd,daytypesa,spdtypesIn,ramezanIn,L,weatherIn,FittedWeather,flagDaa);